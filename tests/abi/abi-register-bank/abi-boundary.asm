...
C166_TEST_NESTED_VECTOR_PROC PROC TASK C166_TEST_NESTED_VECTOR_TASK INTNO C166_TEST_NESTED_VECTOR_INUM = 07BH
@IF( @TASKING_MODEL_IS_MEDIUM )
        JMPS 000h,0E800h
@ELSE
        JMPS 019h,01000h
@ENDI
C166_TEST_NESTED_VECTOR_PROC ENDP
C166_TEST_IRQ_VECTOR_PROC PROC TASK C166_TEST_IRQ_VECTOR_TASK INTNO C166_TEST_IRQ_VECTOR_INUM = 023H
@IF( @TASKING_MODEL_IS_MEDIUM )
        JMPS 000h,0E800h
@ELSE
        JMPS 019h,01000h
@ENDI
C166_TEST_IRQ_VECTOR_PROC ENDP
