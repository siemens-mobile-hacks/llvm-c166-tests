...
C166_NOINLINE abi_u32
stack_apply(abi_u16 seed,
            volatile struct abi_stack_arena C166_FAR *arena) {
  volatile abi_u8 C166_FAR *bytes = (volatile abi_u8 C166_FAR *)arena;
...
C166_NOINLINE abi_u32 stack_owner(abi_u16 seed) {
...
C166_NOINLINE abi_u32
stack_reverse_apply(abi_u16 seed,
                    volatile struct abi_stack_arena C166_FAR *arena) {
  return stack_apply(seed, arena);
}
