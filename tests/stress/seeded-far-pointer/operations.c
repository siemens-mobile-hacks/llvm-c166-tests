...
abi_u32 seeded_far_eval(abi_u16 operation,
  ...
  abi_u16 step;
  abi_s16 difference;
  volatile abi_u8 C166_FAR *byte_lhs;
  volatile abi_u8 C166_FAR *byte_rhs;
  volatile abi_u16 C166_FAR *word_lhs;
  volatile abi_u16 C166_FAR *word_rhs;
  volatile struct abi_seeded_far_record C166_FAR *record;
  volatile struct abi_seeded_far_record C166_FAR *neighbor;
