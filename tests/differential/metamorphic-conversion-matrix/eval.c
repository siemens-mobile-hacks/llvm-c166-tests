...
#define TEST_FUNCTION C166_NOINLINE C166_USED
...
TEST_FUNCTION
abi_u32 c166_metamorphic_eval(abi_u16 operation, abi_u32 x, abi_s32 sx,
  ...
  case META_BRANCH_SELECT: {
    ...
    return (branch_value ^ select_value) | ((abi_u32)side_effect << 16) |
           side_effect;
  }
