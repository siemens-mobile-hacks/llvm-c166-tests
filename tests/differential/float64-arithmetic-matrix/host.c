...
static void run_vector(abi_u16 path, abi_u16 vector_id, abi_u16 operation,
  ...
  abi_u16 case_id =
      (abi_u16)(path * ABI_FLOAT64_VECTOR_COUNT * 2U + vector_id * 2U);

  llvm_float64_eval_proxy((abi_u16)(operation + path * 4U),
  ...
  c166_test_check_u32((abi_u16)(case_id - 1U), expected_hi, actual_hi);
  c166_test_check_u32(case_id, expected_lo, actual_lo);
}

#define RUN_VECTOR(id, operation, name, l0, l1, l2, l3, r0, r1, r2, r3,   \
                   e0, e1, e2, e3, nan_ok)                                \
  run_vector(path, id, operation, l0, l1, l2, l3, r0, r1, r2, r3, e0, e1, \
             e2, e3, nan_ok);
